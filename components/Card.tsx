  ...
  return (
    <ShineBorder color={["#A07CFE", "#FE8FB5", "#FFBE7B"]} className="m-5 lg:m-10">
      <div className="flex flex-col p-3 cursor-pointer">
        <div className="my-4"><Image width={10} height={10} alt="icon" src={icon} className="w-10 h-10 rounded-full"/></div>
        ...
        <div className="mt-2 mb-4 flex flex-wrap gap-2">{tech.map(t => <Tech key={t} tech={t}/>)}</div>
